...
def compute_full_sim(dictinput,verbose=False): 
    ...
    if R != None: 
        ...
        # print(f"DEBUG: wbin={wbin}, w={w}, extracted_flux_out={extracted_flux_out}, extracted_flux_inn={extracted_flux_inn}")
        ...
        # print(f"DEBUG: extracted_flux_out={extracted_flux_out}, extracted_flux_inn={extracted_flux_inn}")
    ...
    # print(f"to: {to}, ti: {ti}, photon_out_bin: {photon_out_bin}, photon_in_bin: {photon_in_bin}")
    # print(f"var_in_bin: {var_in_bin}, var_out_bin: {var_out_bin}")
