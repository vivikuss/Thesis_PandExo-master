...
class ExtractSpec():
    ...
    def __init__(self, inn, out, rn, extraction_area, timing):
        ...
        # print(f"DEBUG: ngroups_per_int before assignment = {timing.get('APT: Num Groups per Integration', 'NOT FOUND')}")

        # ##bandaid fix
        # timing["APT: Num Groups per Integration"] = max(timing["APT: Num Groups per Integration"], 2)


        self.ngroups_per_int = timing["APT: Num Groups per Integration"]
        #print('NOISE: ',timing["APT: Num Groups per Integration"])
        self.nint_out = timing["Num Integrations Out of Transit"]
        #print('NOISE: ',timing["Num Integrations Out of Transit"])
        self.nint_in = timing["Num Integrations In Transit"]
        #print('NOISE: ',timing["Num Integrations In Transit"])
        self.tframe = timing["Seconds per Frame"]
        #print('NOISE: ',timing["Seconds per Frame"])
        self.rn = rn 
        ...
        # print(f"DEBUG: tframe = {self.tframe}")
        # print(f"DEBUG: ngroups_per_int = {self.ngroups_per_int}")
        # print(f"DEBUG: nint_in = {self.nint_in}, nint_out = {self.nint_out}")
    ...
    def run_f_minus_l(self):
        ...
        # print(f"DEBUG: curves_inn['extracted_flux'] = {curves_inn['extracted_flux']}")
        # print(f"DEBUG: curves_out['extracted_flux'] = {curves_out['extracted_flux']}")
        # print(f"DEBUG: curves_inn['extracted_flux'][1] = {curves_inn['extracted_flux'][1]}")
        # print(f"DEBUG: curves_out['extracted_flux'][1] = {curves_out['extracted_flux'][1]}")
        # print(f"DEBUG: on_source_in = {on_source_in}, on_source_out = {on_source_out}")
        ...
        # print(f"DEBUG: extracted_flux_out = {extracted_flux_out}")
        # print(f"DEBUG: extracted_flux_inn = {extracted_flux_inn}")
